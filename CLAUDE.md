...
Guidance for AI-assisted work in this repository — and a briefing for human contributors. The rules below are project law; most are enforced by tests, all are enforced by review.
